...
import com.czStudio.cms.fileInfo.mapper.SysFileInfoMapper;
...
public class SysFileInfoServiceImpl implements ISysFileInfoService
{
    ...
    public int deleteSysFileInfoByFileIds(Long[] fileIds)
    {
        for (int i = 0; i<fileIds.length; i++){
            ...
            String filePath = czStudioConfig.getProfile() + StringUtils.substringAfter(sysFileInfo.getFilePath(), Constants.RESOURCE_PREFIX);
